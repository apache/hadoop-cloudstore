...
```
hadoop jar cloudstore-1.6.jar iampolicy s3a://example-bucket/
...
Example
```
>  hadoop jar cloudstore-1.6.jar listobjects -limit 500  s3a://aws-public-blockchain/v1.0/eth/
...
```bash
hadoop jar cloudstore-1.6.jar regions
