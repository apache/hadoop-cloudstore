...
```
> hadoop jar cloudstore-1.5.jar tlsinfo
...
```
> hadoop jar cloudstore-1.5.jar tlsinfo amazon
...
```
> hadoop jar cloudstore-1.5.jar tlsinfo -verbose amazon
...
```
hadoop jar cloudstore-1.5.jar tlsinfo unknown 
