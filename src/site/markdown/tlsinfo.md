...
```
> hadoop jar cloudstore-1.6.jar tlsinfo
...
```
> hadoop jar cloudstore-1.6.jar tlsinfo amazon
...
```
> hadoop jar cloudstore-1.6.jar tlsinfo -verbose amazon
...
```
hadoop jar cloudstore-1.6.jar tlsinfo unknown 
