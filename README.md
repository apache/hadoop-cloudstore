...
```
hadoop jar cloudstore-1.5.jar gcscreds gs://bucket/
...
```bash
> bin/hadoop jar cloudstore-1.5.jar list -limit 10 s3a://landsat-pds/
...
```bash
bin/hadoop jar cloudstore-1.5.jar pathcapability
...
```bash
hadoop jar cloudstore-1.5.jar pathcapability fs.s3a.capability.select.sql s3a://landsat-pds/
